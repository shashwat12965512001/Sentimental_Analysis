...
def predict():
    ...
    try:
        ...
        if "file" in request.files:
            ...
            graphss = base64.b64encode(graph.getbuffer()).decode("ascii")
            return jsonify({"graph": graphss, "predictions": str(predictions.getvalue().decode('utf-8'))})
            ...
            # response.headers["X-Graph-Data"] = graphss
